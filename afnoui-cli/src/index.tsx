 ...
 */
async function safeInstall(dependencies: string[], isDev = false) {
...
program
    ...
    .action(async () => {
        ...
        try {
            ...
            if (!response.ok) throw new Error("Failed to fetch component list");
            const components = (await response.json()) as string[];
