...
import { code, data } from "@/registry/infinite-field/infinite-field-combobox-auto";
...
import { InfiniteComboboxField } from "@/forms/react-hook-form";
...
/>`;
  ...
  return (
    <ComponentInstall
      ...
      variant="infinite-field-combobox-auto"
      title={data.title}
      code={snippet}
      fullCode={code}
    >
