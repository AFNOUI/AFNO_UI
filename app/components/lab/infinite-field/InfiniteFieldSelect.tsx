...
import { code, data } from "@/registry/infinite-field/infinite-field-select";
...
export function InfiniteFieldSelect() {
  ...
  const snippet = `import { InfiniteSelectField } from "@/forms/react-hook-form";
