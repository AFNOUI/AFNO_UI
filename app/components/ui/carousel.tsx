...
const CarouselContent = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => {
    ...
    return (
      <div ref={carouselRef} className="overflow-hidden w-full min-w-0">
        <div
          ref={ref}
          className={cn("flex min-w-0", orientation === "horizontal" ? "-ms-4" : "-mt-4 flex-col", className)}
          {...props}
        />
      </div>
    );
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <div
        ...
        className={cn("min-w-0 shrink-0 grow-0 basis-full overflow-hidden", orientation === "horizontal" ? "ps-4" : "pt-4", className)}
        {...props}
      />
    );
  },
 ...
 * --------------
 * Colors:
 *   - hsl(var(--primary))          Line: 258 - CarouselDots button class "bg-primary"
 *                                  Active carousel dot indicator background
 *   - hsl(var(--muted-foreground)) Line: 259 - CarouselDots button class
 *                                  "bg-muted-foreground/30 hover:bg-muted-foreground/50"
 *                                  Inactive dot color and hover state
 *
 * Note: Navigation buttons use Button component; see button.tsx for their variables.
 */
