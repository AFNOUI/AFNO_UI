 ...
 * --------------
 * Colors:
 *   - hsl(var(--input))     Line: 35 - InputOTPSlot class "border-input"
 *                            Slot border color
 *   - hsl(var(--ring))      Line: 36 - InputOTPSlot class "ring-ring"
 *                            Active slot focus ring color
 *   - hsl(var(--background)) Line: 36 - InputOTPSlot class "ring-offset-background"
 *                            Focus ring offset
 *   - hsl(var(--foreground)) Line: 43 - InputOTPSlot caret class "bg-foreground"
